...
public class VistaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        dialogEscribir.setPreferredSize(new java.awt.Dimension(582, 500));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        //Al pulsar el boton de guardar archivo:
        try {
            guardarFichero();
        } catch (IOException ex) {
            //Capturamos un posible error que salta si el fichero no es valido
        }
    ...
    public void guardarArchivo() throws IOException, ParseException{ 
        ...
        else if(jFormattedTextField1.getValue() ==null){
